    ...
    <main>
        ...
        <section class="text-about mt-5">
            ...
            <div class="container">
                ...
                <h2 style="font-size: 80px; font-weight: bold;" class="description-space mb-4">Gallery</h2>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card rounded shadow-lg" style="height: 34rem;">
                            ...
                            <a href="<?php echo BASEURL . 'gallery/detail' ?>"><img src="<?php echo ASSETS . 'website/ev-2.png' ?>" class="card-img-top" alt="..."></a>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card rounded shadow-lg" style="height: 34rem;">
                            ...
                            <a href="<?php echo BASEURL . 'gallery/detail' ?>">
