<main>
    ...
    <section class="text-about mt-5">
        ...
        <div class="container">
            ...
            <h2 style="font-size: 80px; font-weight: bold;" class="description-space mb-4">Updates</h2>

            <div class="row mb-4">

                <div class="col-md-4">

                    <div class="card rounded shadow-lg" style="height: 34rem;">

                        <a href="<?php echo BASEURL . 'updates/detail' ?>"><img src="<?php echo ASSETS . 'website/up1.jpeg' ?>" class="card-img-top" alt="..."></a>

                        <div class="card-body">

                            <h5>Unveiling New <br> Innovations for Your Next <br> Big Event</h5>

                        </div>

                        <div class="badge-date">

                            <span class="">16<br>Jan</span>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card rounded shadow-lg" style="height: 34rem;">
                        ...
                        <a href="<?php echo BASEURL . 'updates/detail' ?>">

                            <img src="<?php echo ASSETS . 'website/up2.jpeg' ?>" class="card-img-top" alt="...">
                        ...
                        <div class="card-body">
                            ...
                            <h5>Client Stories that Showcase <br> Nusantara's Event Magic</h5>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card rounded shadow-lg" style="height: 34rem;">
                        ...
                        <a href="<?php echo BASEURL . 'updates/detail' ?>">
                            ...
                            <img src="<?php echo ASSETS . 'website/up3.jpeg' ?>" class="card-img-top" alt="...">
                        ...
                        <div class="card-body">
                            ...
                            <h5>How Nusantara Adapts to <br> Elevate Your Experience</h5>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card rounded shadow-lg" style="height: 34rem;">
                        ...
                        <a href="<?php echo BASEURL . 'updates/detail' ?>"><img src="<?php echo ASSETS . 'website/up4.jpeg' ?>" class="card-img-top" alt="..."></a>

                        <div class="card-body">

                            <h5>Nusantara Champions <br> Eco-Conscious Events</h5>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card rounded shadow-lg" style="height: 34rem;">
                        ...
                        <a href="<?php echo BASEURL . 'updates/detail' ?>">
                            ...
                            <img src="<?php echo ASSETS . 'website/up5.jpeg' ?>" class="card-img-top" alt="...">
                        ...
                        <div class="card-body">
                            ...
                            <h5>Unveiling Nusantara's Hidden <br> Gems for Unforgettable Gatherings</h5>
