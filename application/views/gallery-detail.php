            ...
            <div class="container-fluid mt-5">
                ...
                <div class="row description-space mt-3">
                    <div class="col-lg-12 col-md-12">
                        <img src="<?php echo ASSETS . 'website/gl-1.jpeg' ?>" class="img-fluid rounded mx-auto d-block mb-3">
                        <img src="<?php echo ASSETS . 'website/gl-2.jpeg' ?>" class="img-fluid rounded mx-auto d-block mb-3">
                        <img src="<?php echo ASSETS . 'website/gl-3.jpeg' ?>" class="img-fluid rounded mx-auto d-block mb-3">
                        <img src="<?php echo ASSETS . 'website/gl-4.jpeg' ?>" class="img-fluid rounded mx-auto d-block mb-3">
                        <img src="<?php echo ASSETS . 'website/gl-5.jpeg' ?>" class="img-fluid rounded mx-auto d-block mb-3">
                    </div>
                </div>
            </div>
        </section>
